		...
		for (int i = 0; i < Main.tokenList.size(); ++i)
		{
			...
			else
			{
				...
				else
				{
					...
					{
						rpn.add(Main.tokenList.get(i).getLexema());
					}
					else
					{
						if (buffer.isEmpty() & Main.tokenList.get(i).getStr() != "=" & Main.tokenList.get(i).getStr() != ";")
						{
							buffer.add(Main.tokenList.get(i));
						}
						else
						{
							if (Main.tokenList.get(i).getStr() == "+" | Main.tokenList.get(i).getStr() == "-" | Main.tokenList.get(i).getStr() == ">" | Main.tokenList.get(i).getStr() == "<" | Main.tokenList.get(i).getStr() == "==" | Main.tokenList.get(i).getStr() == "!=")
							{
								while (!buffer.isEmpty())
								{
									if (buffer.get(buffer.size()-1).getLexema() == "MATH")
									{
										rpn.add(buffer.get(buffer.size()-1).getLexema());
							...
							{
								if (buffer.get(buffer.size()-1).getStr() == "*" || buffer.get(buffer.size()-1).getStr() == "/")
								{
